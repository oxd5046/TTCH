...
export default function ManageCaregiversSecNav(props) {
  ...
  return (
    <Stack.Navigator>
      <Stack.Screen name="Parent Caregivers" options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}, headerLeft: () => null}}>
        {(props) => (
      ...
      <Stack.Screen name="Caregiver Primary" component={CaregiverPrimary} options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}}}/>
    </Stack.Navigator>
  );
}
