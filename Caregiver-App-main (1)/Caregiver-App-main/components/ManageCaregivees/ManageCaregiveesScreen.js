...
export default function ManageCaregiveesScreen(props) {
  ...
  return (
    <Stack.Navigator>
      <Stack.Screen name="Manage Caregivees" options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}, headerLeft: () => null}}>
        {(props) => (
          <ManageCaregivees
            {...props}
      ...
      <Stack.Screen name="Caregivee Primary" component={CaregiveePrimary} options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}}}/>
    </Stack.Navigator>
  );
}
