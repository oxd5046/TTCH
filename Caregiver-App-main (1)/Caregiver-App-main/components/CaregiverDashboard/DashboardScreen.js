...
export default function DashboardScreen(props) {
  ...
  const list = [
    ...
    return (
      <Stack.Navigator>
        <Stack.Screen name="Caregiver Dashboard" options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}, headerLeft: () => null, headerRight: () => (
        ...
        <Stack.Screen name="Notification Details" component={NotificationDetails} options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}}} />
      </Stack.Navigator>
    );
  }