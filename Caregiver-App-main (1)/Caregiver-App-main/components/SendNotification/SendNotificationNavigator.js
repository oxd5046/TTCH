...
export default function SendNotificationNavigator(props) {
  ...
  const deleteButtonPressed = () => {
    ...
    return (
      <Stack.Navigator>
        <Stack.Screen name="New Notification" options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}, headerLeft: () => null, headerRight: () => null}}>
        ...
        <Stack.Screen name="Create Task" options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}}}>
        ...
        <Stack.Screen name="Edit Task" options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}}}>
