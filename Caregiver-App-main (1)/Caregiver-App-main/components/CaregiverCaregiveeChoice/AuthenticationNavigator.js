  ...
  const logout = () => {
    ...
    return (
      <Stack.Navigator>
        ...
        <Stack.Screen name="Caregiver Profile" component={CaregiverProfile} options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}, headerShown: true, headerRight: () => (
          <Button onPress={() => logout()} title={'Log Out'} style={styles.logoutButton}></Button>
        ) }}>
        </Stack.Screen>
        <Stack.Screen name="Parent Profile" component={ParentProfile} options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}, headerShown: true, headerRight: () => (
          <Button onPress={() => logout()} title={'Log Out'} style={styles.logoutButton}></Button>
        ) }}>
        </Stack.Screen>
        <Stack.Screen name="Caregivee Profile" component={CaregiveeProfile} options={{ headerTintColor: "#2188da", headerTitleStyle: {fontWeight: "bold"}, headerShown: true, headerRight: () => (
          <Button onPress={() => logout()} title={'Log Out'} style={styles.logoutButton}></Button>
        ) }}>
        </Stack.Screen>
      </Stack.Navigator>
